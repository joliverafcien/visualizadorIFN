...
var style_DatosGeneralesIFN_BN_TOTAL_ecoReg_sinCosteroshp_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("nombre_pm") !== null) {
            labelText = String(feature.get("nombre_pm"));
        }
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.4 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(1,208,255,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(97,255,118,0.5647058823529412)'})}),
